 ...
 *
 * `AWEMetadataScraper` implementations should be largely immutable,
...
class AWEMetadataScraper
{
	public:
		 ...
		 *			aborted.
		 **/
		virtual bool prepare(AWEGlobalSettings* settings) = 0;
...
Q_DECLARE_INTERFACE(AWEMetadataScraper, "com.awe.metadata.scraper/0.1")
