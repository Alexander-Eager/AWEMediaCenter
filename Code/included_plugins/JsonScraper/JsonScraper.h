...
namespace AWE
{
	...
	class JsonScraper : public MetadataScraper
	{
		public:
			 ...
			 * \param[in] config The settings for the scraper.
			 **/
			 ...
			 **/
			virtual QList<MediaItem*> scrapeDataForFile(Folder* placeInMe, QString file,
				bool askUser, bool import, bool inheritMetadata);
		...
		private:
			...
			/** \brief The default properties. **/
			JsonValue myDefaultProperties;
			 ...
			 **/
			bool executeProcedure(JsonValue procedure, QRegularExpressionMatch backrefs,
				bool askUser, bool import, bool inheritMetadata);
