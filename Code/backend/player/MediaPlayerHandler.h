#ifndef MEDIA_PLAYER_HANDLER_H
#define MEDIA_PLAYER_HANDLER_H
...
namespace AWE
{
	...
	/**
	 * \brief Handler for a media player.
	 *
	 * This automatically loads and unloads the plugin,
	...
	class AWEMC_BACKEND_LIBRARY MediaPlayerHandler : public MetadataHolder
	{
		...
		public slots:
			 ...
			 * will add `file` to the queue and return `true`,
			 * but will NOT `emit startedPlaying(file)` until
		...
		signals:
			 ...
			 *
			 * This will be sent whenever `close()` is called
